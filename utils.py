...
# best solution then 0.8 (underfitting) or 0.95 (overfitting)
TRAIN_SIZE = 0.9

NUM_PTS = 971

# increase CROP_SIZE led to better MSE-loss then baseline 128 
# and 224*224 input size is recomended for resnext
CROP_SIZE = 224

# increase SCALE_SIZE led to better MSE-loss then baseline 128
SCALE_SIZE = 250
...
class ScaleMinSideToSize(object):
    def __init__(self, size=(SCALE_SIZE, SCALE_SIZE), elem_name='image'):
